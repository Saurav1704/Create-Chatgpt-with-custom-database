...
#     try:
#         query_result, column_names = read_sql_query(response_gemini, "MAKT.db")
#         if query_result:
#             df = pd.DataFrame(query_result, columns=column_names)
#             response_df = df   # changes
...
#         response_df = pd.DataFrame()
#         response_md = f"An error occurred: {e}"
...
#                         st.write("Graphical Representation")
#                         x_label = response_df.columns[0]
#                         x_data  = response_df.iloc[:5,0]
#                         y_label = response_df.columns[1]
#                         y_data  = response_df.iloc[:5,0]
#                         st.bar_chart( data = response_df , x = x_label , y = y_label , x_label= x_label ,y_label = y_label)
#                 else:
